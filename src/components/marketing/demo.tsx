    ...
    <section id="demo" className="bg-black text-white">
      <div className="mx-auto max-w-[1280px] px-6 py-16">
        <div className="grid gap-8 md:grid-cols-[1.1fr_0.9fr]">
          <div>
            <div className="font-mono text-xs tracking-[0.2em] text-zinc-500">START WITHOUT AWS CREDENTIALS</div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6">
            <div className="font-mono text-xs tracking-widest text-zinc-500">DEMO SCENARIOS • 5</div>
