  ...
  return (
    <section className="bg-black text-white">
      <div className="mx-auto max-w-[1280px] px-6 py-16 text-center">
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm text-zinc-400">Start with Demo Mode — no AWS account, realistic workflow, Naira context.</p>
        <div className="mt-6 flex justify-center gap-3">
          <a href="/onboarding" className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-black hover:bg-zinc-100">Explore NairaGuard</a>
