    ...
    <div className="rounded-xl border border-zinc-200 bg-white p-5">
      ...
      <div className="mt-3 space-y-2">
        {sorted.map((s) => {
          ...
          return (
            <Link key={s.service} href={`/costs/${slug}`} className="flex items-center justify-between gap-3 border-b border-zinc-100 py-2 hover:bg-zinc-50">
              <span className="text-sm truncate hover:underline">{s.service}</span>
